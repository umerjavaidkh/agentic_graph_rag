...
# A previously-collected test file may have stubbed src.shared.auth/src.shared.auth.rbac_setup
# (MagicMock GraphRBAC) or src.unstructured.graph (no tenancy submodule) — this file needs
